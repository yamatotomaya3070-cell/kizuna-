    ...
    <div className="p-4 md:p-8 max-w-4xl mx-auto pb-20">
      ...
      <section className="bg-white border border-slate-200 rounded-2xl p-5 mb-6 shadow-sm">
        ...
        <input
          ...
          className="block w-full text-xs text-slate-600 file:mr-3 file:px-3 file:py-2 file:rounded-xl file:border-0 file:bg-indigo-50 file:text-indigo-700 file:font-semibold hover:file:bg-indigo-100"
        />
        ...
        {parseErrors.length > 0 && (
          <div className="mt-3 rounded-xl bg-amber-50 border border-amber-200 p-3">
            ...
            <ul className="list-disc ml-4 text-xs text-amber-700 space-y-0.5">
            ...
            <button
              ...
              className={`mt-3 flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold transition-all ${
                importing
                  ...
                  : "bg-indigo-600 text-white shadow-sm active:scale-[0.98]"
              }`}
            >
              {importing ? (
                <>
          ...
          >
            <div
              className={`flex items-center gap-1 font-bold text-xs ${
                importResult.errors.length > 0 ? "text-amber-700" : "text-emerald-700"
              }`}
            >
              {importResult.errors.length > 0 ? (
                <AlertTriangle size={13} />
