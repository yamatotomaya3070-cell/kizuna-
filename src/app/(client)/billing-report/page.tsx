    ...
    <div className="min-h-screen bg-slate-50 pb-12">
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: "食事提供加算", key: "lunch" as const, color: "bg-slate-100 text-blue-900", desc: "昼食:○の日" },
            { label: "送迎加算(往復)", key: "transportBoth" as const, color: "bg-slate-100 text-blue-900", desc: "送迎:○の日" },
          ...
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handlePDF}
                disabled={summaries.length === 0}
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-white text-blue-900 hover:bg-slate-100 disabled:opacity-50 transition-colors"
              >
                <FileText size={13} />
                実績記録票PDF
              </button>
